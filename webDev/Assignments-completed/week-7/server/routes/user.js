...
userRouter.get('/courses', async (req, res) => {
    ...
    try{
        ...
        console.log("Something wrong with the database, error in user course get request");
        console.log(e);    
        res.status(500);
    }
});
...
userRouter.get('/purchasedCourses', async (req, res) => {
    ...
    try{
        ...
        const user = await userModel.findById(userId).populate('coursesBought.courseId');
